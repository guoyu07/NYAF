...
manual_header();
?>
<div id="class.yaf-exception-loadfailed-module" class="reference">

 <h1 class="title">The Yaf_Exception_LoadFailed_Module class</h1>
 

 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>


  <div class="section" id="yaf-exception-loadfailed-module.intro">
  ...
  <div class="section" id="yaf-exception-loadfailed-module.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <strong class="classname">Yaf_Exception_LoadFailed_Module</strong>
     </span>
