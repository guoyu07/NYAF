...
/*  
  ...
  $Id: file-entities.php.in 310568 2011-04-27 15:43:49Z bjori $
*/
...
$out_dir = ($not_windows  || !strcasecmp('CYGWIN',php_uname()))? '/tmp/doc-zh/doc-base' : abs_path(strip_cygdrive('/tmp/doc-zh/doc-base'));
$src_dir = ($not_windows  || !strcasecmp('CYGWIN',php_uname()))? '/tmp/doc-zh/doc-base'  : abs_path(strip_cygdrive('/tmp/doc-zh/doc-base'));
$base_dir = ($not_windows || !strcasecmp('CYGWIN',php_uname()))? '/tmp/doc-zh/doc-base' : abs_path(strip_cygdrive('/tmp/doc-zh/doc-base'));
$root_dir = ($not_windows || !strcasecmp('CYGWIN',php_uname()))? '/tmp/doc-zh' : abs_path(strip_cygdrive('/tmp/doc-zh'));
$only_dir = ($not_windows || !strcasecmp('CYGWIN',php_uname()))? '/tmp/doc-zh/en' : abs_path(strip_cygdrive('/tmp/doc-zh/en'));
...
function file_entities($work_dir, $trans_dir, $orig_dir, &$entities, $prefix=false) {
    ...
    if ($arBroken === null) {
        ...
        if ('yes' == 'yes' && file_exists($brokenFilePath)) {
