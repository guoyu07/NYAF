...
manual_header();
?>
<div id="yaf-request-abstract.isget" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Yaf_Request_Abstract::isGet</h1>
  <p class="verinfo">(Yaf &gt;=1.0.0)</p><p class="refpurpose"><span class="refname">Yaf_Request_Abstract::isGet</span> &mdash; <span class="dc-title">The isGet purpose</span></p>
 ...
 <div class="refsect1 description" id="refsect1-yaf-request-abstract.isget-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="type"><span class="type void">void</span></span> <span class="methodname"><strong>Yaf_Request_Abstract::isGet</strong></span>
