...
manual_header();
?>
<div id="class.yaf-exception-dispatchfailed" class="reference">

 <h1 class="title">The Yaf_Exception_DispatchFailed class</h1>
 

 <div class="partintro"><p class="verinfo">(Yaf &gt;=1.0.0)</p>


  <div class="section" id="yaf-exception-dispatchfailed.intro">
  ...
  <div class="section" id="yaf-exception-dispatchfailed.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <strong class="classname">Yaf_Exception_DispatchFailed</strong>
     </span>
